...
tokenizer = AutoTokenizer.from_pretrained(MODEL, add_prefix_space=True, model_max_length=MAX_LENGTH)
...
if __name__ == '__main__':
    ...
    # wt
    # index_texts = tokenizer(index_texts_wt, is_split_into_words=True, padding='max_length', truncation=True, return_tensors='pt').to(device)
    label_texts = tokenizer(label_texts_wt, is_split_into_words=True, padding='max_length', truncation=True, return_tensors='pt').to(device)
    # not wt
